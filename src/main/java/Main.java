...
public class Main {
    ...
    public static List<List<String>> readFileGetListMater(String path) throws IOException {
        ...
        try {
            ...
            // Create a BufferedReader with buffer array size of 16384 (32786 bytes = 32
            // KB).
    ...
    public static void printIndexPage(List<String> listStaff) throws IOException {
        ...
        try (
            ...
            int nombrePage = 10;// TODO: nombre de page à générer
            SecondThread thread = new Thread(nombrePage);
            // Header
